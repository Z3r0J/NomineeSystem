...
namespace NominaProject.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEmployee,Documents,FirstName,LastName,DepartmentId,JobPosition,MonthlySalary,User,Password")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmployee,Documents,FirstName,LastName,DepartmentId,JobPosition,MonthlySalary,User,Password")] Employee employee)
        {
